...
class Client implements Serializable {
    ...
    void createSocket() {
        ...
        try {
            ...
            System.out.println("Clientparticipent har startat");
...
class Server implements Serializable {
    ...
    void createServerSocket() {
        ...
        try {
            ...
            ChatParticipent thisParticipent = new ChatParticipent(mySocket);
            System.out.println("serverparticipent har startat");
        } catch (IOException e) {
            System.out.println("Error reading from file");
        } finally {
            try {
                ...
                outStream.close();
                objectOutput.close();
                objectInput.close(); */    //GLÖM INTE CLOSEA DESSA!!!
...
class ChatParticipent implements ObjectStreamListener {
    //INSTANSVARIABLER
    ...
    void sendMessage(String message){
        try {
            ...
            Logger.getLogger(ChatParticipent.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    void StreamingProcess() {
        ...
        try {
            ...
            ObjectStreamManager ourObjectStreamManager = new ObjectStreamManager(identityNumber, objectInput, this);
            //m = (String) objectInput.readObject();
    ...
    public void objectReceived(int number, Object theObject, Exception e) {
        if (e == null) {
            ...
            theWindow.chattArea.append(theMessage);
        }
    }
}
/**
